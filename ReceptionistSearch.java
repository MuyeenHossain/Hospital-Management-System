...
public class ReceptionistSearch extends JFrame implements ActionListener
{
	...
	public ReceptionistSearch(JFrame frame)
	{
		...
		search.setBounds(250,250,150,40);
		...
		staffSearch = new JLabel("ID NO   :");
		staffSearch.setBounds(80,170,100,50);
		...
		TFstaff.setBounds(200,180,250,30);
	...
	public void Test()
	{
		...
		try
		{
			...
			query = "select * from receptionist where ID="+TFstaff.getText();
